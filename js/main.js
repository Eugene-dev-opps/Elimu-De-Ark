    ...
    if($("ul.products").length) {
        ...
        product.each(function() {
            ...
            quickViewLink.on("click", function(e) {
                e.preventDefault();
                $(this).closest(".product").find(".quick-view-single-product").addClass("active-quick-view-single-product");
            ...
            closeQuickView.on("click", function(f) {
                singleProduct.removeClass("active-quick-view-single-product");
